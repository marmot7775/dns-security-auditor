...
The IETF published RFC 9989 in May 2026 on the Standards Track, together with RFC 9990 (aggregate reporting) and RFC 9991 (failure reporting). Together they obsolete RFC 7489 and RFC 9091. Receiver deployment is gradual, so this tool analyzes RFC 9989 alongside RFC 7489 and shows domain owners where their records stand under each.
